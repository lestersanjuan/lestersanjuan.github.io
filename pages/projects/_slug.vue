        ...
        <div class="space-y-9">
          <div class="py-0.5 border-t border-b border-dashed border-gray-700 flex items-center justify-between">
            <div class="text-indigo-400 font-bold">
              <nuxt-link class="hover:text-indigo-300" :to="localePath('/projects')">{{ $t('projects.header') }}</nuxt-link> <span class="text-gray-500">/</span> <span class="text-gray-300">{{ project.tech }}</span>
            </div>
          ...
          <div class="px-4 sm:px-0 lg:px-4 pb-4 bg-gray-900 rounded-lg">
            ...
            <div class="prose dark:prose-dark break-words my-4 prose-sm max-w-4xl mx-auto text-gray-200">
