        ...
        <div class="flex-1 flex flex-col justify-between">
          <div>
            ...
            <nuxt-link class="group" :to="localePath(`/projects/${project.slug}`)">
              <h3 class="mt-0.5 group-hover:text-indigo-400 text-md leading-7 font-semibold text-gray-100">
                {{ project.title }}
              </h3>
          ...
          <div class="flex mt-3 space-x-3 flex-row text-gray-300">
            <a target="_blank" rel="noreferrer" :href="project.website" class="hover:text-indigo-400">
            ...
            <a target="_blank" rel="noreferrer" :href="project.github" class="hover:text-indigo-400">
